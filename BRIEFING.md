...
*As at Saturday 15 August 2026. Rebuilt automatically on every run — there is nothing to refresh.*
...
**5** open consultations · **15** developments to review

## Respond — things with a deadline

| Closes | What | Suggested next step |
|---|---|---|
| Closes 07 September | [Consultation: Implementing the Building Safety (Wales) Act 2026](https://www.gov.wales/implementing-building-safety-wales-act-2026-html)<br><sub>Welsh Government — Consultation (notification)</sub> | Decide whether to respond, and who drafts it. |
